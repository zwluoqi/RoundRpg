...
//		if (!considerInactive && !UGUITools.GetActive(content.gameObject)) return;
//
...
//		}
	...
	/// But this code is:
	/// 
	/// target.position += UGUIMath.SpringDampen(ref velocity, 9f, Time.deltaTime);
	/// </summary>
...
//		Camera cam = UGUITools.FindCameraForLayer(layer);
//
//		if (cam == null)
//		{
...
//	{
//		Camera myCam = UGUITools.FindCameraForLayer(trans.gameObject.layer);
...
//	{
//		Camera myCam = UGUITools.FindCameraForLayer(trans.gameObject.layer);
//		Camera worldCam = UGUITools.FindCameraForLayer(target.gameObject.layer);
