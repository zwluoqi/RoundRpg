...
//		Camera[] cameras = UGUITools.FindActive<Camera>();
...
//
	...
	static public void SetDirty (UnityEngine.Object obj)
	{
		...
		if (obj)
		{
			//if (obj is Component) Debug.Log(UGUITools.GetHierarchy((obj as Component).gameObject), obj);
			//else if (obj is GameObject) Debug.Log(UGUITools.GetHierarchy(obj as GameObject), obj);
...
//		UIRoot root = (trans != null) ? UGUITools.FindInParents<UIRoot>(trans.gameObject) : null;
//
...
//		if (root == null)
//		{
//			GameObject go = UGUITools.AddChild(null, false);
...
//			Camera cam = UGUITools.AddChild<Camera>(root.gameObject, false);
...
//			AudioListener[] listeners = UGUITools.FindActive<AudioListener>();
...
//
//			if (UGUITools.IsChild(trans, panel.transform))
//			{
...
//	}
	...
	[System.Obsolete("Use UGUITools.GetActive instead")]
...
//	}
	...
	static public bool Save (string fileName, byte[] bytes)
	{
		...
		return false;
		#else
		if (!UGUITools.fileAccess) return false;
	...
	static public byte[] Load (string fileName)
	{
		...
		return null;
		#else
		if (!UGUITools.fileAccess) return null;
