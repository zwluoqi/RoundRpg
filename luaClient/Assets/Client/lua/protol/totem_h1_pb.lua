...
local IPHONE = protobuf.Descriptor();
local IPHONE_PHONES_FIELD = protobuf.FieldDescriptor();
...
PHONE.extensions = {}
IPHONE_PHONES_FIELD.name = "phones"
IPHONE_PHONES_FIELD.full_name = ".iPhone.phones"
IPHONE_PHONES_FIELD.number = 1
IPHONE_PHONES_FIELD.index = 0
IPHONE_PHONES_FIELD.label = 3
IPHONE_PHONES_FIELD.has_default_value = false
IPHONE_PHONES_FIELD.default_value = {}
IPHONE_PHONES_FIELD.message_type = PHONE
IPHONE_PHONES_FIELD.type = 11
IPHONE_PHONES_FIELD.cpp_type = 10

IPHONE.name = "iPhone"
IPHONE.full_name = ".iPhone"
IPHONE.nested_types = {}
IPHONE.enum_types = {}
IPHONE.fields = {IPHONE_PHONES_FIELD}
IPHONE.is_extendable = false
IPHONE.extensions = {}

Person = protobuf.Message(PERSON)
Phone = protobuf.Message(PHONE)
iPhone = protobuf.Message(IPHONE)
