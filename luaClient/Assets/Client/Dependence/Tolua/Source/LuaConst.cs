...
{
    public static string luaDir = Application.dataPath + "/Client/Lua";                //lua逻辑代码目录
	public static string toluaDir = Application.dataPath + "/Client/Dependence/Tolua/ToLua/Lua";        //tolua lua文件目录
