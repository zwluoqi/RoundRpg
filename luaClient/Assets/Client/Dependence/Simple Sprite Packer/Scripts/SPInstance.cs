...
namespace SimpleSpritePacker
{
	public class SPInstance : ScriptableObject {
		...
		public void QueueAction_AddSprite(Object resource)
		{
			...
			{
				//重复资源不再添加
				if(this.m_Sprites.Find(a=>(a.name == resource.name)) != null)
					return;
		...
		public void QueueAction_UpdateSprites(Object[] resources){
			foreach (Object resource in resources)
			{
				if (resource == null)
					continue;
				this.QueueAction_UpdateSprite(resource);
			}
		}
		...
		public void QueueAction_DeleteAllSprites(){
