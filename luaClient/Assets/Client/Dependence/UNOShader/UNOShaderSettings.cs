...
public static class UNOShaderSettings
{
	...
	public static string UNOShaderDirPath ="Client/Dependence/UNOShader/";//<<--- Change this path if UNOshader is in a different Directory ( path starts from the Assets directory)
